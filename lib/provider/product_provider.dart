...
import 'package:medosedo_vendor/data/model/response/product_review_model.dart';
import 'package:medosedo_vendor/data/model/response/review_model.dart' as rm;
import 'package:medosedo_vendor/data/model/response/top_selling_product_model.dart';
import 'package:medosedo_vendor/data/repository/product_repo.dart';
...
class ProductProvider extends ChangeNotifier {
  ...
  //! update Price
  Future<void> updateProductUnitPrice(
      {int? productId, double? unitPrice, BuildContext? context}) async {
    ApiResponse apiResponse =
