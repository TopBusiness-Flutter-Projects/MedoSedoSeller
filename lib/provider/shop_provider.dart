...
import 'package:medosedo_vendor/data/model/response/add_product_model.dart';
import 'package:medosedo_vendor/data/model/response/attr.dart';
import 'package:medosedo_vendor/data/model/response/attribute_model.dart';
import 'package:medosedo_vendor/data/model/response/base/api_response.dart';
import 'package:medosedo_vendor/data/model/response/base/error_response.dart';
import 'package:medosedo_vendor/data/model/response/brand_model.dart';
import 'package:medosedo_vendor/data/model/response/category_model.dart';
import 'package:medosedo_vendor/data/model/response/config_model.dart';
import 'package:medosedo_vendor/data/model/response/edt_product_model.dart';
import 'package:medosedo_vendor/data/model/response/image_model.dart';
import 'package:medosedo_vendor/data/model/response/product_model.dart';
import 'package:medosedo_vendor/data/model/response/variant_type_model.dart';
...
class SellerProvider extends ChangeNotifier {
  ...
  Future addProductImage(BuildContext context, ImageModel imageForUpload, Function callback) async {
    ...
    if(response.response != null && response.response!.statusCode == 200) {
      ...
      callback(true, name, type, map['color_image'] != null ? map['color_image']['color'] : "");
      notifyListeners();
    }else {
      _isLoading = false;
      ApiChecker.checkApi(context, response);
