...
import 'package:medosedo_vendor/data/model/body/delivery_man_body.dart';
import 'package:medosedo_vendor/data/model/response/base/api_response.dart';
import 'package:medosedo_vendor/data/model/response/collected_cash_model.dart';
import 'package:medosedo_vendor/data/model/response/delivery_man_detail_model.dart'
    as d;
import 'package:medosedo_vendor/data/model/response/delivery_man_earning_model.dart';
import 'package:medosedo_vendor/data/model/response/delivery_man_model.dart';
import 'package:medosedo_vendor/data/model/response/delivery_man_order_history_model.dart';
import 'package:medosedo_vendor/data/model/response/delivery_man_review_model.dart';
import 'package:medosedo_vendor/data/model/response/delivery_man_withdraw_detail_model.dart';
import 'package:medosedo_vendor/data/model/response/delivery_man_withdraw_model.dart';
import 'package:medosedo_vendor/data/model/response/order_history_log_model.dart';
...
import 'package:medosedo_vendor/helper/api_checker.dart';
...
class DeliveryManProvider extends ChangeNotifier {
  ...
  Future<void> addDeliveryManToOrder(
      {required BuildContext context,
      required int? orderId,
      required int status}) async {
    _isLoading = true;
    ApiResponse apiResponse;
    apiResponse = await deliveryManRepo!.addDeliveryManToOrder(
        orderId,
        selectedDeliveryMan!.id ?? 1,
        int.parse(taxPrice.text ?? "0"),
        selectedDate.text);
    if (apiResponse.response != null &&
        apiResponse.response!.statusCode == 200) {
      getDeliveryManDetails(context, orderId);
      _deliveryManDetails!.deliveryMan!.isActive = status;
      _isLoading = false;
      showCustomSnackBar(
          getTranslated('status_updated_successfully', context), context,
