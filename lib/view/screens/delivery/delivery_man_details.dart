...
import 'package:medosedo_vendor/view/screens/delivery/widget/collect_cash_from_delivery_man_screen.dart';
import 'package:medosedo_vendor/view/screens/delivery/widget/delivery_man_earning_list.dart';
import 'package:medosedo_vendor/view/screens/delivery/widget/delivery_man_order_history.dart';
import 'package:medosedo_vendor/view/screens/delivery/widget/delivery_man_review_list.dart';
import 'package:medosedo_vendor/view/screens/delivery/widget/overview_widget.dart';
...
class _DeliveryManDetailsScreenState extends State<DeliveryManDetailsScreen>
  ...
  void initState() {
    ...
    Provider.of<DeliveryManProvider>(context, listen: false)
        .getDeliveryManDetails(context, widget.deliveryMan!.id);
    Provider.of<DeliveryManProvider>(context, listen: false)
