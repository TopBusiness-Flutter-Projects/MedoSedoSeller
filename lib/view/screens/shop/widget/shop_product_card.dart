...
import 'package:medosedo_vendor/view/base/image_diaglog.dart';
import 'package:medosedo_vendor/view/screens/addProduct/add_product_screen.dart';
import 'package:medosedo_vendor/view/screens/product/product_details.dart';
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        widget.isDetails &&
                                widget.productModel!.deniedNote != null
                            ? Padding(
                                padding: const EdgeInsets.only(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: Text(
                                          widget.productModel!.deniedNote!,
                                          overflow: TextOverflow.ellipsis,
                                          maxLines: 50,
                                          style: robotoRegular.copyWith(
                                              fontSize: Dimensions
                          ...
                          onPressed: () {
                            showModalBottomSheet(
                                ...
                                builder: (con) => EditProductScreen(
                                    ...
                                    unitPrice: widget.productModel!.unitPrice!,
                          ...
                          onPressed: () {
                            order
                              ...
                              productId: widget.productModel!.id!,
                                ...
                                .then((value) {
                              int? userId = Provider.of<ProfileProvider>(
                                      context,
                                      listen: false)
                                  .userId;
