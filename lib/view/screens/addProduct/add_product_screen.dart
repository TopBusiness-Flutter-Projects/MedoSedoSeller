...
import 'package:medosedo_vendor/view/screens/addProduct/widget/add_product_next_Screen.dart';
import 'package:medosedo_vendor/view/screens/addProduct/widget/digital_product_widget.dart';
import 'package:medosedo_vendor/view/screens/addProduct/widget/select_category_widget.dart';
import 'package:medosedo_vendor/view/screens/addProduct/widget/title_and_description_widget.dart';
             ...
             return!resProvider.isLoading? Container(height: 50,
               ...
               onTap: (){
                 ...
                 child: Container(width: MediaQuery.of(context).size.width, height: 40,
                   ...
                   child: Center(child: Text(getTranslated('Continue',context)!, style: TextStyle(
